// routes/lactationDataRoutes.js
const express = require('express');
const router = express.Router();
const lactationDataController = require('../controllers/lactationDataController');
 ...
 */
router.post('/lactationData', lactationDataController.createLactationData);

/**
 * @swagger
 * /api/lactationData/animal/{animalId}:
 *   get:
 ...
 */
router.get('/lactationData/animal/:animalId', lactationDataController.getLactationDataByAnimalId);

/**
 * @swagger
 * /api/lactationData/{id}:
 *   put:
 ...
 *         description: Bad request
 */
router.put('/lactationData/:id', lactationDataController.updateLactationData);
 ...
 *         description: Lactation data not found
 */
router.delete('/lactationData/:id', lactationDataController.deleteLactationData);
